package sortprojectpackage.main;
...
public class Empirical
{
    ...
    private enum SIZE
    {
        ONE_THOUSAND(1000, 0), FIVE_THOUSAND(5000, 1), TEN_THOUSAND(10000, 2), TWENTY_THOUSAND(20000, 3),
            FIFTY_THOUSAND(50000, 4), SIZES(5, 5), ALGORITHMS(4, 4);
        private int value;
    ...
    private static void printData(String order)
    {
        ...
        for(int i = -1; i < ALGORITHMS.length; i++)
        {
            if(i == -1)
            {
                System.out.printf("%15s\t%5d\t%5d\t%5d\t%5d\t%5d", order, SIZE.ONE_THOUSAND.value,
                        SIZE.FIVE_THOUSAND.value, SIZE.TEN_THOUSAND.value, SIZE.TWENTY_THOUSAND.value,
                        SIZE.FIFTY_THOUSAND.value);
                System.out.println();
            }
            else
            {
                System.out.printf("%15s\t%5d\t%5d\t%5d\t%5d\t%5d", ALGORITHMS[i], times[SIZE.ONE_THOUSAND.sizeNumber][i],
